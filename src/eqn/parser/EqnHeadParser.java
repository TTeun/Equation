...
public class EqnHeadParser {
    ...
    static public EqnHead parseEquationHead(String equationHeadString) throws BadHeaderException {
        ...
        EqnHead equationHead = new EqnHead(functionName);
